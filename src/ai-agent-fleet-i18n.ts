...
export const aiAgentFleetContent = {
    ...
    sections: {
      ...
      numbers: {
        ...
        table: {
          ...
          rows: [
            ['Estrellas en GitHub', '68.826'],
            ['Forks', '13.023'],
            ['Contribuidores', '327'],
            ['PRs fusionadas', '1.298'],
  ...
  en: {
    ...
    tldr: 'career-ops is my open source job-search system: 68,826 GitHub stars, 327 contributors and 1,298 merged PRs as of today. I maintain it evenings and weekends, around my full-time job. A fleet of Claude Code agents does the mechanical work — triage, testing, review briefs, release mechanics, community metrics. Hard gates keep them honest, and every real failure gets distilled into a rule they load on boot.',
    tldrCoin: {
      pre: ' ',
      term: 'Agentic maintenance',
